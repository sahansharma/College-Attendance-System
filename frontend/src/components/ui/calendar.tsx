  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: "flex justify-center pt-1 mb-2 items-center px-10 h-9",
        ...
        weekday:
          "text-muted-foreground rounded-md w-10 font-normal text-[0.8rem] flex justify-center items-center",
        ...
        day_button: cn(
          ...
          "h-10 w-10 p-0 font-normal aria-selected:opacity-100 aria-selected:bg-primary aria-selected:text-primary-foreground"
        ),
